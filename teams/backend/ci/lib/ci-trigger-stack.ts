      ...
      [
        {
          ...
          objectPrefix: `backend/apps/template-manager`,
        },
      ],
      options
    );
    // argocd-apps-team-backend
    const arn = `arn:aws:codepipeline:${props.env?.region}:${props.env?.account}:${props.stage}-argocd-apps-team-backend`;
